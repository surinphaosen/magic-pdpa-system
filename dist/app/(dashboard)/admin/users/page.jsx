...
export default function UserManagementPage() {
    ...
    return (<div className="flex-1 space-y-6 p-6">
          ...
          <DialogContent className="sm:max-w-[425px]">
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="username" value={newUser.username} onChange={(e) => setNewUser(Object.assign(Object.assign({}, newUser), { username: e.target.value }))} className="col-span-3"/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="email" className="text-right">
                  Email
                </Label>
                <Input id="email" type="email" value={newUser.email} onChange={(e) => setNewUser(Object.assign(Object.assign({}, newUser), { email: e.target.value }))} className="col-span-3"/>
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="role" className="text-right">
                  Role
                </Label>
                <Select onValueChange={(value) => setNewUser(Object.assign(Object.assign({}, newUser), { role: value }))}>
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Select onValueChange={(value) => setNewUser(Object.assign(Object.assign({}, newUser), { department: value }))}>
                  <SelectTrigger className="col-span-3">
              ...
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="password" type="password" value={newUser.password} onChange={(e) => setNewUser(Object.assign(Object.assign({}, newUser), { password: e.target.value }))} className="col-span-3"/>
              </div>
            </div>
            <DialogFooter>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {userStats.map((stat) => (<Card key={stat.label}>
