...
const mockLogDetails = {
    ...
    "LOG-002": {
        ...
        correctiveActions: "Investigating source of breach, reviewing access controls, preparing notification to authorities",
...
export default function LogDetailsPage() {
    ...
    const id = params.id;
    const logData = mockLogDetails[id];
    if (!logData) {
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <ul className="mt-2 list-disc list-inside space-y-1">
                    {logData.immediateActions.map((action, index) => (<li key={index} className="text-gray-900">
                        {action}
                      </li>))}
                  </ul>
                </div>
