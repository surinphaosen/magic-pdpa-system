...
export default function AssetsPage() {
    ...
    const filteredData = mockAssetData.filter((item) => {
        ...
        const matchesUserDepartment = (user === null || user === void 0 ? void 0 : user.role) === "Admin" || (user === null || user === void 0 ? void 0 : user.department) === item.owner.split(" ")[0];
            ...
            return (<TableRow key={item.id}>
                    ...
                    <TableCell>
                      <div className="flex flex-wrap gap-1">
                        {item.dataTypes.slice(0, 2).map((type) => (<Badge key={type} variant="secondary" className="text-xs">
                            {type}
                          </Badge>))}
                        {item.dataTypes.length > 2 && (<Badge variant="secondary" className="text-xs">
