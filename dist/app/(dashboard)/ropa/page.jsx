...
export default function RopaPage() {
    ...
    const fetchRopaData = () => __awaiter(this, void 0, void 0, function* () {
        try {
            const res = yield fetch("/api/ropa");
    ...
    const filteredData = ropaData.filter((item) => {
        ...
        const matchesUserDepartment = (user === null || user === void 0 ? void 0 : user.role) === "Admin" || (user === null || user === void 0 ? void 0 : user.department) === item.department;
          ...
          <div className="flex gap-4">
            <div className="flex-1">
              <div className="relative">
                ...
                <Input placeholder="Search RoPA records..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10"/>
              </div>
            </div>
            ...
            {(user === null || user === void 0 ? void 0 : user.role) === "Admin" && (<Select value={departmentFilter} onValueChange={setDepartmentFilter}>
                <SelectTrigger className="w-[180px]">
