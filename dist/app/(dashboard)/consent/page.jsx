...
export default function ConsentPage() {
    ...
    const isReadOnly = (user === null || user === void 0 ? void 0 : user.role) === "Department User";
    return (<div className="flex-1 space-y-6 p-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {consentStats.map((stat) => (<Card key={stat.label}>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {recentConsents.map((consent) => (<TableRow key={consent.id}>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {consentForms.map((form) => (<TableRow key={form.id}>
        ...
        <TabsContent value="lookup" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex gap-4">
                <div className="flex-1">
                  <div className="relative">
                    ...
                    <Input placeholder="Search by email or phone number..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="pl-10"/>
                  </div>
                </div>
                <Button>
              ...
              {searchTerm && (<div className="border rounded-lg p-4">
