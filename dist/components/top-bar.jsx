...
export function TopBar() {
    ...
    const { user } = useAuth();
    return (<div className="h-14 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="h-8 px-2">
                ...
                <span className="text-xs">{user === null || user === void 0 ? void 0 : user.name}</span>
              </Button>
            </DropdownMenuTrigger>
