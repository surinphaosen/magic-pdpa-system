...
export const getSensitivityBadge = (sensitivity) => {
    switch (sensitivity) {
        case "normal":
            return "secondary";
        case "sensitive":
...
export const getLocalizedPurpose = (item, language) => {
