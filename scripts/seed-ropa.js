...
const { AppDataSource } = require(path.join(__dirname, "../dist/lib/typeorm-data-source.js"));
const { RopaRecord } = require(path.join(__dirname, "../dist/lib/entity/RopaRecord.js"));
